    ...
    return [
        ...
        },
        {
            ...
            "function": {
                ...
                "description": "Execute a SELECT query on the database to answer the user's question. Only SELECT queries are allowed (read-only). This should typically be your FINAL step after understanding the database structure using get_database_context.",
                "parameters": {
                    "type": "object",
                    "properties": {
                        "query": {
